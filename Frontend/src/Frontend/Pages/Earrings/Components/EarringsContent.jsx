...
import styles from './EarringsContent.module.scss';
import axios from 'axios';

const EarringsContent = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.category === 'Earrings');
    ...
    // "Earrings" kategorisindeki ürünlerin listesini ekranda gösterin
    return (
...
export default EarringsContent;
