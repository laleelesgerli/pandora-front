...
import styles from './BraceletsContent.module.scss';
...
const BraceletsContent = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.category === 'Bracelets');
    ...
    // "Bracelets" kategorisindeki ürünlerin listesini ekranda gösterin
    return (
        <div className={styles.necklacesContent}>
            <div className={styles.necklacesHeading}>
                <h1>BRACELETS</h1>
                <p>Mix up your wrist stack with a new Pandora bracelet. Whether you love a customizable charm bracelet or a sleek bangle, find your new everyday icon in our bracelets for women collection. Choose from sterling silver, 14k rose gold-plated and 14k gold-plated bracelets.</p>
            </div>
...
export default BraceletsContent;
